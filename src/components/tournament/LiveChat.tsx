    ...
    <div className="flex flex-col h-full">
      <div className="flex-1 overflow-y-auto space-y-2 p-1 sm:p-2">
        {messages.map((msg, idx) => (
          <div key={idx} className="bg-white/10 rounded p-2 text-sm sm:text-base">
      ...
      <div className="flex gap-2 mt-3">
        <input
          ...
          className="flex-1 bg-black/50 border border-white/20 rounded px-3 py-3 text-white text-base"
          placeholder="Type a message..."
        />
        <button
          onClick={sendMessage}
          className="bg-purple-600 px-4 py-3 rounded-lg hover:bg-purple-700 text-base font-medium shrink-0"
        >
          Send
        </button>
      </div>
